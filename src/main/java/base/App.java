...
public class App {
    ...
    public static void main(String[] args) {
        ...
        myApp.findInvestment(principal, rate, years);
    }
    int getPrincipal()
    {
    ...
    void findInvestment(int principal, double rate, int years)
    {
        double worth = principal * (1 + rate * years);
        System.out.printf("After %d years at %.1f%%, the investment will be worth $%.0f.", years, rate * 100, worth);
    }
}
